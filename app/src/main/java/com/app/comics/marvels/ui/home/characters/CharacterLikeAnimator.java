...
public class CharacterLikeAnimator extends DefaultItemAnimator {
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        if (preInfo instanceof CharacterItemHolderInfo) {
            ...
            CharacterAdapter.CharacterViewHolder holder = (CharacterAdapter.CharacterViewHolder) newHolder;

            if (CharacterAdapter.ACTION_LIKE_IMAGE_DOUBLE_CLICKED.equals(recipesItemHolderInfo.updateAction)) {
    ...
    private void animatePhotoLike(final CharacterAdapter.CharacterViewHolder holder) {
